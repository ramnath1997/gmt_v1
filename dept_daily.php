...
<!--Total Report Generation-->
    ...
    <?php 
        ...
        while($j<$counti)
        {
            ...
            while($row=mysql_fetch_array($id_query))
            {
                $student_subject=$row['id_subject']; $gmt_no=$row['gmt_no']; $act_td_qsn=$row['act_td'.$student_subject.''];
            }
            if($student_subject=="")
            {                
                $j++;
        ...
        echo "<center><p style='color: yellow;' > TOTAL DEPARTMENT RESULT </p></n                          center>";
...
<!--Column chart Ends-->
                    ...
                    <a href='dept_daily_d.php'><button>Back</button></a>
                    </div></body></html>