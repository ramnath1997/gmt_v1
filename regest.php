						...
						if(isset($_POST['staff_id'])){
							if(trim($_POST['staff_id'])){
								...
								if(isset($_POST['staff_name'])){
									...
									mysql_query("UPDATE table_staff_details SET staff_dept='{$staff_dept}' WHERE staff_id='".$_POST['staff_id']."' ");
								}
								if(isset($_POST['staff_password'])){
									...
									mysql_query("UPDATE table_staff_details SET access='' WHERE staff_id='".$_POST['staff_id']."' ");
								}
								$t='1';
							}
						}
