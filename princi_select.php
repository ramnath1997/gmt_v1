...
<a href="./hodacc.php"><button>Register/Edit/Delete HOD</button></a>

<a href="./princi_gmt.php"><button>GMT Status</button></a>
<a href="./princi_ind.php"><button>Individual Report</button></a>

<a href="./princi_date_select.php"><button>College Report (Marks)</button></a>

<a href="./princi_date_pending.php"><button>College Report (Pending)</button></a>
<a href="./password_princi.php" ><button>Change Password</button></a>
