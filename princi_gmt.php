...
<a href="./princi_status.php"><button>Class Report</button></a>
<a href="./q_report.php"><button>Dept Report (Questions)</button></a>
<a href="./m_report.php"><button>Dept Report (Marks)</button></a>
