...
if ($_SERVER["REQUEST_METHOD"] == "POST" )
	{
		...
		if(isset($_POST['staff_reg']))
		{
			...
			{
                if(isset($_POST['staff_edit_name'])){
                    if(trim($_POST['staff_edit_name']!="")){
				if(isset($_POST['staff_id'])){
				$w=$_POST['staff_id'];
                $edit_name=$_POST['staff_edit_name'];
				...
				{
					$c='1';
					mysql_query("UPDATE `table_staff_details` SET `staff_name`='$edit_name' WHERE staff_id='$w'  AND type='2'");

				}
					}
                }
                }
				$_POST['staff_id']=$_POST['staff_edit_name']=$_POST['staff_id']=$_POST['staff_dept']=$_POST['staff_password']="";
			}
			}
		}
...
<form name="staff_reg" method="POST">
									...
									<p>Enter HOD ID						
                                        ...
                                        <input type="text" name="staff_edit_name"  placeholder="Edit Name" value="" />
