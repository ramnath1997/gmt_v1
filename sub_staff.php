			...
			{						
						if( isset($_POST['student_course']) AND isset($_POST['student_dept']) AND isset($_POST['student_sem']) ){
								...
								{	
									...
									if(isset($_POST['staff_reg_id'])){
										$_SESSION['staff_reg_id']=$_POST['staff_reg_id'];
									 header("location: register_staff_w_sub.php");
									}
...
<html>
    <head>
        <title>Subject - Staff Portal</title>
    ...
    <body>
        ...
        <div class="main-agileits">
            <h1>Subject - Staff Allocation Form</h1>
...
<form method="post">
	<p >Staff Name </p><p>
		<select  name='staff_reg_id' required>
...
?>
									...
									<p>Student Course<p>
										<select id="Course_staff_select" name='student_course' onchange='getBranch(this.value)' required>
											<option selected>Select Course</option>
											<?php
											
												$degree_query=mysql_query("SELECT id_course, value_course FROM table_course  ORDER BY id_course");
									...
									<p>Student Dept<p>
										...
										<select id="Branch" name='student_dept' onchange=" getSem_princi_select(this.value)" required>
											<option selected>Branch</option>
										</select>
										
									<p>Student Sem<p>
										
										<select id="sem_princi_select" name="student_sem" ">
