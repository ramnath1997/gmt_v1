...
<form name="student_reg" method="POST">
									...
									<p>Student Sem<p>
										...
										<p>No. of Students<p>
										<input type="text" name="student_no"  placeholder="Numbers In Integer"  value="" />
...
if ($_SERVER["REQUEST_METHOD"] == "POST" )
	{
		if(isset($_POST['student_reg']))
		{
			if(trim($_POST['student_reg'])=="yes")
			{
							...
							if( isset($_POST['student_year'])  AND isset($_POST['student_course']) AND isset($_POST['student_no']) AND isset($_POST['student_dept']) AND isset($_POST['student_sem']) ){
								if( trim($_POST['student_year'])!=""  AND trim($_POST['student_course'])!="0" AND trim($_POST['student_dept'])!="0" AND trim($_POST['student_no'])!="" AND trim($_POST['student_sem'])!="0" ){
								...
								{	
									...
									header("location: dynamictrial.php");
