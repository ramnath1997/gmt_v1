...
$tz_object = new DateTimeZone('Asia/Kolkata');
    ...
    <?php if ($_SERVER["REQUEST_METHOD"] == "POST" )
    {
        ...
        { 
            ...
            header('location: dept_daliy_qsn.php');
        }}}
        if(isset($_POST['mark']))
        {
            if(isset($_POST['date']))
        ...
        {
            $_SESSION['gmt_date']=$_POST['date'];
            header("location: dept_daily.php");
        }}}}?>
...
<p>Select Date<p>
                                     ...
                                     <input input type="submit" name="qsn" value="View Question">
                                     <input input type="submit" name="mark" value="View Marks">
                                    </form>
                    </div><a href='hp_select.php'><button>Back</button></a></div>
                    </div>
                    </div></body></html>